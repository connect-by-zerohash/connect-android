...
const SRC = fileURLToPath(
  new URL("../../../connectsdk/src/main/assets/automation/withdraw.js", import.meta.url)
);
...
const DOM_HELPERS = readFileSync(
  fileURLToPath(new URL("../../../connectsdk/src/main/assets/automation/dom-helpers.js", import.meta.url)),
  "utf8"
);
