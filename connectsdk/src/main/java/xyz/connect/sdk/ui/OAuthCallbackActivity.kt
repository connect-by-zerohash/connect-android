 ...
 *
 * Splitting the exported surface like this isolates the JWT-bearing activity
 * from any externally-launched intent: external callers can only reach
 * [OAuthCallbackActivity], and the only thing they can deliver is a URI
 * matching the connectsdk-oauth scheme.
 */
