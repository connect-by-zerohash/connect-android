 ...
 * the iOS bridge and the browser-extension transport use. The web side is
 * platform-agnostic and posts to both `NativeIOS` and `NativeAndroid`, so no
 * web change is needed.
 *
