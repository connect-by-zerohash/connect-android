...
class AutomationSessionChallengeGateTest {
    ...
    private val sessionKt: String =
        File("src/main/java/xyz/connect/sdk/automation/AutomationSession.kt").readText()
    private val bridgeKt: String =
        File("src/main/java/xyz/connect/sdk/automation/AutomationBridge.kt").readText()
    ...
    fun theChallengeProbeStringLiteralExistsInExactlyOnePlace() {
        val owners = File("src/main/java/xyz/connect/sdk/automation")
