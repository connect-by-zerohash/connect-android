...
class BrandTest {
    ...
    @Test
    fun defaultBrand_isConnectForThisSdk() {
        // connect-android defaults to the connect lockup; a future flip
        // (to ZEROHASH or SECURED_CONNECT) would need to be deliberate.
        assertEquals(Brand.CONNECT, Brand.DEFAULT)
    }
}
